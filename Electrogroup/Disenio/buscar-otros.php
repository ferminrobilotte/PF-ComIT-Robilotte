...
$conn=conectar();
//$valor=$_POST['precio'];
$sql="SELECT * FROM articulo WHERE Categoria='Otros'";
//if($valor=='mayor'){
    ...
    <div class="container">
        <div class="row">
            <div class="col-6 marcas">
                <p><?php echo $cantidad; ?> resultados para </p><a href="principal.php">Electrogroup</a> > <p><a href="buscar-otros.php">Otros</a></p>  
            </div>
            <!--<div class="col-6">
