...
$conn=conectar();
//$valor=$_POST['precio'];
$sql="SELECT * FROM articulo WHERE Categoria='Lavado' OR Categoria='Limpieza'";
//if($valor=='mayor'){
    ...
    <div class="container">
        <div class="row">
            <div class="col-6 marcas">
                <p><?php echo $cantidad; ?> resultados para </p><a href="principal.php">Electrogroup</a> > <p><a href="buscar-lav-limp.php">Lavado y Limpieza</a></p>  
            </div>
            <!--<div class="col-6">
